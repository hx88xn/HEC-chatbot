...
async def generate_session_analysis(history: list[dict]) -> dict:
    ...
    system_prompt = """You are a supportive educational quality reviewer for CM Punjab's AI Career Counsellor programme. Evaluate the counselling session between a Pakistani Intermediate student (STUDENT) and the AI counsellor (AGENT).
