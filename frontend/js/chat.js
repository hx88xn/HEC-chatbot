...
export function triggerGreeting() {
  ...
  apiStream(
    "/chat/stream",
    { session_id: sessionId, message: "Hello, I have uploaded my marksheet. Please greet me warmly as the CM Punjab Career Counsellor's Portal assistant and start the counselling session." },
    (delta) => {
      fullText += delta;
    ...
    (err) => {
      finalizeStreamingBubble(assistantBubble, "Welcome to the CM Punjab Career Counsellor's Portal! I'm your AI career counsellor, here to help you find the best path forward after Intermediate. Could you tell me about your subjects and interests?\n\n[SUGGESTIONS: \"I'm in FSc Pre-Medical\" | \"I'm in FSc Pre-Engineering\" | \"I need help choosing a field\" | \"What career options do I have?\" | \"I want to study abroad\"]");
      isStreaming = false;
      btnSend.disabled = false;
    }
  );
